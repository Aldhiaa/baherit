            ...
            <div class="techin-sidemenu-body">
                ...
                <div class="techin-contact-info-wrap">
                    <div class="techin-contact-info">
                        ...
                        <h5>{{ __('layout.sidebar.address') }}</h5>
                        <p>{{ setting('site_address', __('layout.sidebar.address_text')) }}</p>
                    </div>
                    <div class="techin-contact-info">
                        <a href="mailto:{{ setting('site_email') }}">
                            <img src="assets/images/blog/gmail.svg" alt="">
                            <h5>{{ __('layout.sidebar.contact') }}</h5>
                            <p>{{ setting('site_email', __('layout.sidebar.email')) }}</p>
                        </a>
                    </div>
                </div>
