        ...
        <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-12">
                        <div class="techin-footer-textarea footer1">
                            ...
                            <p>{{ __('layout.footer.description') }}</p>
            ...
            <div class="techin-footer-bottom bottom2">
                <div class="techin-copywright">
                    <p>Copyright &copy; <span id="current-year"></span> <span class="footer-text">techin</span>. All
                        rights reserved by <span class="footer-text"> favdevs.</span></p>
                </div>
