                        ...
                        <div id="content-en" class="tab-content">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="bio_en" 
                                          id="bio_en" 
                                          rows="4"
                                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white">{{ old('bio_en') }}</textarea>
                                @error('bio_en')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div id="content-ar" class="tab-content hidden">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="bio_ar" 
                                          id="bio_ar" 
                                          rows="4"
                                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white">{{ old('bio_ar') }}</textarea>
                                @error('bio_ar')
                                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
