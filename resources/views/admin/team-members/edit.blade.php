                ...
                <div class="p-6 sm:p-8">
                    <form action="{{ route('admin.team-members.update', $teamMember->id) }}" method="POST">
                        ...
                        <div id="content-en" class="tab-content">
                            ...
                            <div class="mb-6">
                                <label for="position_en" class="block text-lg font-medium text-gray-800 dark:text-gray-200 mb-3">
                                    {{ __('Position (English)') }}
                                    <span class="text-red-500">*</span>
                                </label>
                                <div class="relative">
                                    ...
                                    <input type="text"
                                           ...
                                           class="form-input w-full pl-12 py-4 text-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out rounded-lg shadow-sm border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                                           required placeholder="{{ __('Enter position in English') }}">
                                </div>
                                @error('position_en')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="mb-6">
                                <label for="bio_en" class="block text-lg font-medium text-gray-800 dark:text-gray-200 mb-3">
                                    {{ __('Bio (English)') }}
                                </label>
                                <div class="relative">
                                    ...
                                    <textarea name="bio_en"
                                              ...
                                              placeholder="{{ __('Enter bio in English') }}">{{ old('bio_en', $translations['en']['bio']) }}</textarea>
                                </div>
                                @error('bio_en')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div id="content-ar" class="tab-content hidden">
                            ...
                            <div class="mb-6">
                                <label for="position_ar" class="block text-lg font-medium text-gray-800 dark:text-gray-200 mb-3">
                                    {{ __('Position (Arabic)') }}
                                    <span class="text-red-500">*</span>
                                </label>
                                <div class="relative">
                                    ...
                                    <input type="text"
                                           ...
                                           dir="rtl"
                                           class="form-input w-full pl-12 py-4 text-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out rounded-lg shadow-sm border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                                           required placeholder="{{ __('Enter position in Arabic') }}">
                                </div>
                                @error('position_ar')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="mb-6">
                                <label for="bio_ar" class="block text-lg font-medium text-gray-800 dark:text-gray-200 mb-3">
                                    {{ __('Bio (Arabic)') }}
                                </label>
                                <div class="relative">
                                    <div class="absolute top-4 left-0 pl-4 flex items-start pointer-events-none">
                                    ...
                                    <textarea name="bio_ar"
                                              ...
                                              dir="rtl"
                                              class="form-textarea w-full pl-12 py-4 text-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out rounded-lg shadow-sm border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                                              placeholder="{{ __('Enter bio in Arabic') }}">{{ old('bio_ar', $translations['ar']['bio']) }}</textarea>
                                </div>
                                @error('bio_ar')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <div class="mb-6">
                                <label for="image_url" class="block text-lg font-medium text-gray-800 dark:text-gray-200 mb-3">
                                    {{ __('Image URL') }}
                                </label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            ...
                            <div class="mb-6">
                                <label for="linkedin_url" class="block text-lg font-medium text-gray-800 dark:text-gray-200 mb-3">
                                    {{ __('LinkedIn URL') }}
                                </label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            ...
                            <div class="mb-6">
                                <label for="twitter_url" class="block text-lg font-medium text-gray-800 dark:text-gray-200 mb-3">
                                    {{ __('Twitter URL') }}
                                </label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            ...
                            <div class="mb-6">
                                <label class="flex items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-gray-700 dark:to-gray-800 rounded-xl">
                                    ...
                                    <span class="ml-4 text-lg font-medium text-gray-800 dark:text-gray-200">{{ __('Featured Member') }}</span>
                                </label>
                                @error('is_featured')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400 flex items-center">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
