        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.service-pages.update', $servicePage) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" 
                                   name="page_name" 
                                   id="page_name" 
                                   value="{{ old('page_name', $servicePage->page_name) }}"
                            ...
                            <div class="lang-section" data-lang="en">
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           name="hero_title_en" 
                                           id="hero_title_en"
                                           value="{{ old('hero_title_en', $servicePage->getTranslation('hero_title', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('hero_highlight_en', $servicePage->getTranslation('hero_highlight', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="hero_description_en" 
                                              ...
                                              rows="3"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('hero_description_en', $servicePage->getTranslation('hero_description', 'en')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('hero_button_primary_en', $servicePage->getTranslation('hero_button_primary', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('hero_button_secondary_en', $servicePage->getTranslation('hero_button_secondary', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                            </div>
                            ...
                            <div class="lang-section hidden" data-lang="ar">
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="hero_title_ar" 
                                           dir="rtl"
                                           value="{{ old('hero_title_ar', $servicePage->getTranslation('hero_title', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           dir="rtl"
                                           value="{{ old('hero_highlight_ar', $servicePage->getTranslation('hero_highlight', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="hero_description_ar" 
                                              ...
                                              rows="3" 
                                              dir="rtl"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('hero_description_ar', $servicePage->getTranslation('hero_description', 'ar')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           dir="rtl"
                                           value="{{ old('hero_button_primary_ar', $servicePage->getTranslation('hero_button_primary', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           dir="rtl"
                                           value="{{ old('hero_button_secondary_ar', $servicePage->getTranslation('hero_button_secondary', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="lang-section" data-lang="en">
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           name="find_title_en" 
                                           id="find_title_en"
                                           value="{{ old('find_title_en', $servicePage->getTranslation('find_title', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="find_description_en" 
                                              ...
                                              rows="3"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('find_description_en', $servicePage->getTranslation('find_description', 'en')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           name="filter_all_en" 
                                           id="filter_all_en"
                                           value="{{ old('filter_all_en', $servicePage->getTranslation('filter_all', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('filter_development_en', $servicePage->getTranslation('filter_development', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="filter_cloud_en"
                                           value="{{ old('filter_cloud_en', $servicePage->getTranslation('filter_cloud', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('filter_consulting_en', $servicePage->getTranslation('filter_consulting', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           name="reset_en" 
                                           id="reset_en"
                                           value="{{ old('reset_en', $servicePage->getTranslation('reset', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                            </div>
                            ...
                            <div class="lang-section hidden" data-lang="ar">
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="find_title_ar" 
                                           dir="rtl"
                                           value="{{ old('find_title_ar', $servicePage->getTranslation('find_title', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="find_description_ar" 
                                              ...
                                              rows="3" 
                                              dir="rtl"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('find_description_ar', $servicePage->getTranslation('find_description', 'ar')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="filter_all_ar" 
                                           dir="rtl"
                                           value="{{ old('filter_all_ar', $servicePage->getTranslation('filter_all', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           dir="rtl"
                                           value="{{ old('filter_development_ar', $servicePage->getTranslation('filter_development', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="filter_cloud_ar" 
                                           dir="rtl"
                                           value="{{ old('filter_cloud_ar', $servicePage->getTranslation('filter_cloud', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           dir="rtl"
                                           value="{{ old('filter_consulting_ar', $servicePage->getTranslation('filter_consulting', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="reset_ar" 
                                           dir="rtl"
                                           value="{{ old('reset_ar', $servicePage->getTranslation('reset', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="lang-section" data-lang="en">
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('technology_title_en', $servicePage->getTranslation('technology_title', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="technology_description_en" 
                                              ...
                                              rows="3"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('technology_description_en', $servicePage->getTranslation('technology_description', 'en')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           name="frontend_en" 
                                           id="frontend_en"
                                           value="{{ old('frontend_en', $servicePage->getTranslation('frontend', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           name="backend_en" 
                                           id="backend_en"
                                           value="{{ old('backend_en', $servicePage->getTranslation('backend', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           name="database_en" 
                                           id="database_en"
                                           value="{{ old('database_en', $servicePage->getTranslation('database', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           name="cloud_en" 
                                           id="cloud_en"
                                           value="{{ old('cloud_en', $servicePage->getTranslation('cloud', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           name="learn_more_en" 
                                           id="learn_more_en"
                                           value="{{ old('learn_more_en', $servicePage->getTranslation('learn_more', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                            </div>
                            ...
                            <div class="lang-section hidden" data-lang="ar">
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           dir="rtl"
                                           value="{{ old('technology_title_ar', $servicePage->getTranslation('technology_title', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="technology_description_ar" 
                                              ...
                                              rows="3" 
                                              dir="rtl"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('technology_description_ar', $servicePage->getTranslation('technology_description', 'ar')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="frontend_ar" 
                                           dir="rtl"
                                           value="{{ old('frontend_ar', $servicePage->getTranslation('frontend', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="backend_ar" 
                                           dir="rtl"
                                           value="{{ old('backend_ar', $servicePage->getTranslation('backend', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="database_ar" 
                                           dir="rtl"
                                           value="{{ old('database_ar', $servicePage->getTranslation('database', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="cloud_ar" 
                                           dir="rtl"
                                           value="{{ old('cloud_ar', $servicePage->getTranslation('cloud', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="learn_more_ar" 
                                           dir="rtl"
                                           value="{{ old('learn_more_ar', $servicePage->getTranslation('learn_more', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="lang-section" data-lang="en">
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="process_title_en"
                                           value="{{ old('process_title_en', $servicePage->getTranslation('process_title', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="process_description_en" 
                                              ...
                                              rows="3"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('process_description_en', $servicePage->getTranslation('process_description', 'en')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('process_discovery_en', $servicePage->getTranslation('process_discovery', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="process_discovery_desc_en" 
                                              ...
                                              rows="3"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('process_discovery_desc_en', $servicePage->getTranslation('process_discovery_desc', 'en')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('process_design_en', $servicePage->getTranslation('process_design', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="process_design_desc_en" 
                                              ...
                                              rows="3"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('process_design_desc_en', $servicePage->getTranslation('process_design_desc', 'en')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('process_development_en', $servicePage->getTranslation('process_development', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="process_development_desc_en" 
                                              ...
                                              rows="3"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('process_development_desc_en', $servicePage->getTranslation('process_development_desc', 'en')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('process_deployment_en', $servicePage->getTranslation('process_deployment', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="process_deployment_desc_en" 
                                              ...
                                              rows="3"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('process_deployment_desc_en', $servicePage->getTranslation('process_deployment_desc', 'en')) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="lang-section hidden" data-lang="ar">
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="process_title_ar" 
                                           dir="rtl"
                                           value="{{ old('process_title_ar', $servicePage->getTranslation('process_title', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="process_description_ar" 
                                              ...
                                              rows="3" 
                                              dir="rtl"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('process_description_ar', $servicePage->getTranslation('process_description', 'ar')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           dir="rtl"
                                           value="{{ old('process_discovery_ar', $servicePage->getTranslation('process_discovery', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="process_discovery_desc_ar" 
                                              ...
                                              rows="3" 
                                              dir="rtl"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('process_discovery_desc_ar', $servicePage->getTranslation('process_discovery_desc', 'ar')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           dir="rtl"
                                           value="{{ old('process_design_ar', $servicePage->getTranslation('process_design', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="process_design_desc_ar" 
                                              ...
                                              rows="3" 
                                              dir="rtl"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('process_design_desc_ar', $servicePage->getTranslation('process_design_desc', 'ar')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           dir="rtl"
                                           value="{{ old('process_development_ar', $servicePage->getTranslation('process_development', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="process_development_desc_ar" 
                                              ...
                                              rows="3" 
                                              dir="rtl"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('process_development_desc_ar', $servicePage->getTranslation('process_development_desc', 'ar')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           dir="rtl"
                                           value="{{ old('process_deployment_ar', $servicePage->getTranslation('process_deployment', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="process_deployment_desc_ar" 
                                              ...
                                              rows="3" 
                                              dir="rtl"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('process_deployment_desc_ar', $servicePage->getTranslation('process_deployment_desc', 'ar')) }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="lang-section" data-lang="en">
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           name="cta_title_en" 
                                           id="cta_title_en"
                                           value="{{ old('cta_title_en', $servicePage->getTranslation('cta_title', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="cta_description_en" 
                                              ...
                                              rows="3"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('cta_description_en', $servicePage->getTranslation('cta_description', 'en')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('cta_button_primary_en', $servicePage->getTranslation('cta_button_primary', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('cta_button_secondary_en', $servicePage->getTranslation('cta_button_secondary', 'en')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                            </div>
                            ...
                            <div class="lang-section hidden" data-lang="ar">
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="cta_title_ar" 
                                           dir="rtl"
                                           value="{{ old('cta_title_ar', $servicePage->getTranslation('cta_title', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="cta_description_ar" 
                                              ...
                                              rows="3" 
                                              dir="rtl"
                                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('cta_description_ar', $servicePage->getTranslation('cta_description', 'ar')) }}</textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           dir="rtl"
                                           value="{{ old('cta_button_primary_ar', $servicePage->getTranslation('cta_button_primary', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" 
                                           ...
                                           dir="rtl"
                                           value="{{ old('cta_button_secondary_ar', $servicePage->getTranslation('cta_button_secondary', 'ar')) }}"
                                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                </div>
                            </div>
                        </div>
