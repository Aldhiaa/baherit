                            ...
                            <div class="mb-6">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="description_en"
                                              ...
                                              required placeholder="{{ __('Enter description in English') }}">{{ old('description_en', $translations['en']['description'] ?? '') }}</textarea>
                                </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="description_ar"
                                              ...
                                              dir="rtl"
                                              class="form-textarea w-full pl-12 py-4 text-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150 ease-in-out rounded-lg shadow-sm border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                                              required placeholder="{{ __('Enter description in Arabic') }}">{{ old('description_ar', $translations['ar']['description'] ?? '') }}</textarea>
                                </div>
