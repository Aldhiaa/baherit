    ...
    <div class="techin-sidemenu-wraper">
        <div class="techin-sidemenu-column">
            <div class="techin-sidemenu-body">
                ...
                <p>“TechIN completely transformed our IT infrastructure. Their team was knowledgeable, responsive, and
                    solutions that improved our efficiency. Highly recommended!”</p>
                ...
                <div class="techin-contact-info-wrap">
                    ...
                    <div class="techin-contact-info">
                        <a href="mailto:info@techin.com">
                            <img src="{{ asset('assets/images/blog/gmail.svg') }}" alt="">
                            <h5>Contact</h5>
                            <p>info@techin.com</p>
                        </a>
                    </div>
                ...
                @empty
                    <div class="col-12">
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">Check back soon for our latest projects and case studies.</p>
                        </div>
                    </div>
                @endforelse
            </div>
    ...
    <div class="techin-blog-section dark-bg" style="background-image: url({{ asset('assets/images/blog/blog-bg.png') }})">
        <div class="container">
            <div class="techin-section-title center light">
                ...
                <h2>Discover Our Latest Insights and Updates</h2>
            </div>
            <div class="row">
                @forelse($recentBlogs as $blog)
                    @php
                        ...
                        $blogAuthor = $blog->author_name ?? 'Admin';
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="techin-blog-wrap2">
                            ...
                            <div class="blog-img">
                                ...
                                <a class='techin-default-btn light blog-btn1' data-text='Read More'
                                    href='{{ $blogPermalink }}'>
