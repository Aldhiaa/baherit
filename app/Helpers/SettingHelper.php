...
class SettingHelper
{
    ...
    /**
     * Helper function for easy access in Blade templates
     *
     * @param string $key
     * @param mixed $default
     * @return mixed
     ...
     * @return mixed
     */
    public static function settingTranslated($key, $locale = null, $default = null)
    {
        return self::getTranslated($key, $locale, $default);
    }
}
